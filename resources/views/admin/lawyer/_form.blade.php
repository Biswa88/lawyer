        ...
        <div class="col-lg-6">
                <label>Image</label>
                 ...
                 <div class="col-lg-6">
                    ...
                    {!! Form::select('case_type', $case_type, null,['class'=>'form-control','id'=>'case_type','placeholder'=>'select case_type','autocomplete'=>'off','required'=>'true']) !!}
...
<div class="form-group">
    ...
    {!! Form::textarea('about',null,['class'=>'form-control', 'rows' => 4, 'id'=>'about','placeholder'=>'about','autocomplete'=>'off','required'=>'true']) !!}
