					...
					<div class="col-lg-6">
					 ...
					 <div class="col-lg-6">
                        ...
                        <select name="case_deal" class="form-control">
                            ...
                            @foreach(App\Models\Case_deal::all() as $case_deal)
                            <option value="{{$case_deal->case_deal}}" @if($user->case_deal==$case_deal->case_deal)selected @endif>{{$case_deal->case_deal}}</option> 
                            @endforeach
